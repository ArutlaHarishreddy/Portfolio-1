      ...
      <div className="container mx-auto px-6 py-20">
        ...
        >
          ...
          <h1 className="text-5xl md:text-7xl font-bold text-white mb-6">
            Hi, I'm <span className="text-blue-400">Harish Reddy</span>
          </h1>
          ...
          <div className="flex justify-center gap-6 mb-12">
            <motion.a
              href="https://github.com/ArutlaHarishreddy"
              target="_blank"
            ...
            <motion.a
              href="https://www.linkedin.com/in/arutla-harish-reddy-282994312/"
              target="_blank"
              rel="noopener noreferrer"
              whileHover={{ scale: 1.1 }}
              whileTap={{ scale: 0.95 }}
            ...
            <motion.a
              href="https://mail.google.com/mail/?view=cm&fs=1&to=harisharutlareddy@gmail.com&su=Portfolio%20Inquiry&body=Hi%20Harish%2C%0A%0AI%20checked%20your%20portfolio%20and..."
              target="_blank"
              rel="noopener noreferrer"
              whileHover={{ scale: 1.1 }}
              whileTap={{ scale: 0.95 }}
          ...
          <div className="flex justify-center gap-4 flex-wrap">
            ...
            <motion.a
              href="/Resume/harish_reddy_resume.pdf"
              download="Harish_Reddy_Resume.pdf"
              target="_blank"
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
