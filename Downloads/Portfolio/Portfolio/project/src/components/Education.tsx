  ...
  const education = [
    {
      ...
      achievements: [
        "Maintaining GPA of 7.94 throughout the program",
        "Completed major projects in Machine Learning and IOT ",
    ...
    },
    {
      ...
      achievements: [
        "Achieved 89.4% in final examinations",
    ...
    },
    {
      ...
      achievements: [
        "Achieved GPA of 9.5 in final examinations",
          ...
          >
            ...
            <div className="grid md:grid-cols-3 gap-6">
              <div className="glass-card">
                <div className="text-3xl font-bold text-blue-500 mb-2">7.94</div>
                <div className="text-gray-400">Current GPA</div>
              </div>
              <div className="glass-card">
                <div className="text-3xl font-bold text-purple-500 mb-2">89.4%</div>
                <div className="text-gray-400">12th Grade Score</div>
              </div>
              <div className="glass-card">
                <div className="text-3xl font-bold text-emerald-500 mb-2">9.5</div>
