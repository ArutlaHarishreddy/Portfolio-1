...
import { FaReact, FaNodeJs, FaPython, FaAws, FaBrain } from 'react-icons/fa';
  ...
  const experiences = [
    {
      ...
      period: "2024",
      type: "Internship",
      description: "Applied knowledge of Data Science and Python to analyze and process large datasets for meaningful insights. Developed a Product Recommendation System using machine learning techniques such as data preprocessing, feature engineering, and model training. Utilized libraries like Pandas, NumPy, Scikit-learn, and Matplotlib to build and evaluate the system, improving recommendation accuracy and user experience.",
      achievements: [
        "Analyzed large datasets and extracted insights using Python and data science techniques.",
        "Developed and implemented machine learning algorithms for a Product Recommendation System.",
        "Performed data preprocessing, feature engineering, and model evaluation to enhance accuracy.",
        "Gained hands-on experience with Python libraries like Pandas, NumPy, Scikit-learn, and Matplotlib."
      ],
      technologies: ["Python", "Pandas", "Numpy", "Problem Solving", "Content Filtering", "Collaborative Filtering"],
      techIcons: [<FaBrain />]
    }
  ];
