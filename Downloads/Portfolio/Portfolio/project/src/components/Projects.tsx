...
import { FaReact, FaNodeJs, FaPython, FaAws, FaDatabase, FaMobile, FaFilter, FaBrain, FaUsers, FaChartLine, FaChartBar } from 'react-icons/fa';
...
const Projects: React.FC = () => {
  ...
  const projects = [
    {
      id: 1,
      title: "Product Recommendation System(Internship)",
      description: "Developed a Product Recommendation System using Python and machine learning to suggest relevant products based on user preferences and behavior...",
      ...
      image: "https://cdn.prod.website-files.com/65702cb922266947aed0df47/6756d4bfc3379cf09528b705_65702cb922266947aed0e72e_product_recomendation_engine.png",
      technologies: [
        { name: "Python", icon: <FaPython />, color: "text-yellow-400" },
        { name: "Machine Learning", icon: <FaBrain />, color: "text-blue-500" },
        { name: "Content Based Filtering", icon: <FaFilter />, color: "text-green-500" },
        { name: "Collaborative Based Filtering", icon: <FaUsers />, color: "text-purple-400" },
        { name: "Numpy,Pandas", icon: <SiNumpy />, color: "text-emerald-400" }

      ],
      github: "https://github.com/ArutlaHarishreddy/Product-Recommendation-system",
      demo: "https://github.com/ArutlaHarishreddy/Product-Recommendation-system",
    ...
    {
      id: 2,
      title: "Sustainable Development through Data Analytics for Ride-Sharing Platforms",
      description: "It focuses on using data analytics to promote sustainable urban mobility by studying ride-sharing data to reduce traffic congestion, pollution, and emissions, aligning with UN Sustainable Development Goals...",
      longDescription: "The project “Sustainable Development through Data Analytics for Ride-Sharing Platforms” focuses on analyzing data from Uber, Ola, and Rapido to promote sustainable urban transport. It uses Python, Tableau, and QGIS to study traffic, emissions, and ride patterns. By identifying inefficiencies, it suggests solutions like route optimization and electric vehicle promotion.The goal is to reduce traffic congestion and pollution through data-driven insights.",
      image: "https://www.saliceonline.com/wp-content/uploads/2024/11/Untitled-1-15.jpg",
      technologies: [
        { name: "Python", icon: <FaPython />, color: "text-yellow-400" },
        { name: "Data Analytics", icon: <FaChartLine />, color: "text-yellow-400" },
        { name: "Numpy,Pandas", icon: <SiNumpy />, color: "text-emerald-400" },
        { name: "Matplotlib", icon: <FaChartBar />, color: "text-red-500" },
  ...
  const categories = ["All", "Machine Learning", "Data Science"];
